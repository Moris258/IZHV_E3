...
public class Player : MonoBehaviour
{
    ...
    /*
    /// <summary>
    /// Baker for Player entities.
    /// </summary>
    private Baker mEntityBaker;

    /// <summary>
    /// Entity-Prefab for Player entities.
    /// </summary>
    ...
    */
    ...
    void Start()
    {
        ...
        { // Use the complete conversion workflow.
            ...
            // The old way of instantiating an Entity: 
    ...
    void FixedUpdate()
    {
        ...
        MovePlayer(new Vector3{ 
            x = mMoveInput.x, y = mMoveInput.y, z = 0.0f
        });
    ...
    public void RotatePlayer(Vector3 target)
    {
        ...
        // Allow only rotation in the XY plane (play area).
